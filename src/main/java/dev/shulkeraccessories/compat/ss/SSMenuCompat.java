...
public class SSMenuCompat {
    ...
    private static final DeferredRegister<MenuType<?>> MENU_TYPES =
            DeferredRegister.create(Registries.MENU, ShulkerAccessoriesMod.MOD_ID);

    public static final Supplier<MenuType<ItemStorageContainerMenu>> SS_SHULKER_MENU =
            MENU_TYPES.register("ss_shulker_box",
